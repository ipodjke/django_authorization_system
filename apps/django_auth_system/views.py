...
from django_auth_system import signals, utils
from django_auth_system.compat import get_user_email
...
class UserViewSet(viewsets.ModelViewSet):
    ...
    # отладить при удалении, подумать над
...
def experement(request):
    if request.GET.get('code'):
        ...
        requests.post('http://host.docker.internal:8080/auth/convert-token/', data={
            'grant_type': 'convert_token',
            'client_id': 'CI3JTS7X9ZQx8WObcI73Gxu9g1usbhiAUvzSGB6t',
            # 'client_secret': 'sG2EvhRW1H9FGdlUhTIV',
            'backend': 'vk-oauth2',
